...
typedef enum VectorResult {
	VECTOR_SUCCESS,
	VECTOR_NOT_INITIALIZED_ERROR,				/**< Uninitialized vector error 	*/
	VECTOR_ALLOCATION_ERROR,				/**< malloc error on grow/shrink   */
	VECTOR_INDEX_OUT_OF_BOUNDS_ERROR,
	/* Add more as needed by your implementation */
	VECTOR_GENERAL, /**< if size = 0 or size < nItems */
	
	VECTOR_REALLOCATION_FAILED, /**< reallocation failed */
	
	VECTOR_OVERFLOW, /**< overflow */
	
	VECTOR_UNDERFLOW /**< underflow */
